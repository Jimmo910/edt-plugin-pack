...
| [EDT Comfort](https://github.com/tormozit/EDT.Comfort) | 1.0.1.2 | MIT | навигация, наборы объектов, редактор BSL, отладка, сравнение; интеграция с ИР |
| [EDT MCP Server](https://github.com/DitriXNew/EDT-MCP) | 2.17.1 | **AGPL-3.0** | MCP-сервер для AI-ассистентов _(отдельная категория)_ |
