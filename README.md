...
|--------|--------|----------|------------|
| [EDT Extension Tweaks](https://github.com/Xelgo/edt-extension-tweaks) | 1.1.20 | EPL-2.0 | общий BSL-контекст, конструктор запросов, цепочки обновления |
...
| [EDT MCP Server](https://github.com/DitriXNew/EDT-MCP) | 2.8.1 | **AGPL-3.0** | MCP-сервер для AI-ассистентов _(отдельная категория)_ |
